...
from openmanus.engine import engine
from openmanus.mailbox import mailbox_store
...
class DispatchResult:
    ...
    child_name: str = ""
    mailbox_dispatch_sent: bool = False
    mailbox_result_received: bool = False
    result_preview: str = ""
...
def print_report(results: list[DispatchResult]) -> None:
    ...
    for r in results:
        ok = (
            ...
            and not r.mailbox_result_received
            and not r.error
        )
        emoji = "✅" if ok else "❌"
