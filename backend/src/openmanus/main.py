...
def create_app() -> FastAPI:
    ...
    from .agent_loader import AGENTS_DIR, AVATARS_SEED_DIR
    AGENTS_DIR.mkdir(parents=True, exist_ok=True)
    app.mount("/agent-assets", StaticFiles(directory=str(AGENTS_DIR)), name="agent-assets")

    # Serve bundled avatar presets (offline DiceBear adventurer SVGs) so
    # avatar selection never reaches api.dicebear.com. The directory is
    # backend/seed/avatars/, generated by scripts/gen_avatar_presets.py.
